...
from src.main.main_class import (Driver, abbr_and_time, abbr_name_car,
                                 add_lap_time, add_start_end_time,
                                 build_position_list, create, define_laps_time,
                                 find_driver, init_abb_name_car, print_driver,
...
class TestFunc(unittest.TestCase):
    ...
    def test_add_lap_time(self, mock_lap_time):
        driver = [Driver(abbr='DRR',
                         ...
                         end_time='2018-05-24_12:04:03.332',
                         lap_time=None)]
        self.assertEqual(add_lap_time(driver), [drivers[0]])
    ...
    def test_build_position_list(self):
        self.assertEqual(build_position_list(drivers),
    ...
    @patch('src.main.main_class.build_position_list',
           return_value=['1. Daniel Ricciardo  |RED BULL RACING TAG HEUER |0:01:04.415',
                         '-' * 59])
    def test_print_report(self, mock_build_position_list):
        self.assertEqual(print_report(drivers, 'asc'), None)
